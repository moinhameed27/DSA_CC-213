...
int main()
{
    ...
    while (true)
    {
        cout << "\nDoubley Linked List (Two Pointer) Operations Menu:" << endl;
        ...
        cout << "7. Insert in Increasing Order" << endl;
        cout << "8. Insert in Decreasing Order" << endl;
        ...
        case 6:
            ...
            break;
        case 7:
            cout << "Enter value to insert in increasing order: ";
            characterValidation(value);
            list.sortedInsertionIncreasing(value);
            list.print();
            break;
        case 8:
            cout << "Enter value to insert in decreasing order: ";
            characterValidation(value);
